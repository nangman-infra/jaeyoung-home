...
def REPO_SLUG = 'nangman-infra/jaeyoung-home'
def MAIN_BRANCH_REF = 'refs/heads/main'
def DEFAULT_REPO_HTTP_URL = 'https://github.com/nangman-infra/jaeyoung-home.git'
...
pipeline {
    ...
    triggers {
        GenericTrigger(
            ...
            causeString: 'jaeyoung-home main push detected',
